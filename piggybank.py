        ...
        if self.config_args['new_config'] == True:
            ...
            try:
                ...
                if not config.has_option('piggybank','pb_claim_gas'):
                    ...
                    logging.info("pb_claim_gasPrice = 0xb2d05e00  # Default gas price for claiming(5000000000) - 5GWEI")
                    logging.info("pb_claim_gas = 0xa64d8  # Default gas for claiming(303072)")
